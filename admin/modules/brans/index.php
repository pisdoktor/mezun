...
function delIl(&$cid) {
	...
	mosRedirect( 'index.php?option=admin&bolum=brans', 'Seçili branş(lar) silindi' );
}
...
function saveIl() {
	...
	mosRedirect('index.php?option=admin&bolum=brans', 'Branş kaydedildi');
...
function cancelIl() {
	...
	$row->bind( $_POST );
	$row->checkin();
	mosRedirect( 'index.php?option=admin&bolum=brans');
}
