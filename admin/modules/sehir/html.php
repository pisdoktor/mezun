...
class IlHTML {
	static function editIl($row) {
		?>
		<div id="module_header">Şehir <?php echo $row->id ? 'Düzenle' : 'Ekle';?></div>
		<div id="module">
...
<form action="index.php" method="post" name="adminForm">
<div align="right">
<input type="button" name="button" value="Yeni Şehir Ekle" onclick="javascript:submitbutton('add');" class="button" />
