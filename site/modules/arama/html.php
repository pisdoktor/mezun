...
<input name="name" id="name" type="text" class="inputbox" alt="name" placeholder="Adınızı ve soyadınızı yazın" size="15" />
</div>

<div class="row">
<label for="username">Kullanıcı Adı:</label>
<input name="username" id="username" type="text" class="inputbox" alt="username" placeholder="Kullanıcı adınızı yazın" size="15" />
</div>

<div class="row">
<label for="cinsiyet">Cinsiyeti:</label>
<?php echo $reg->userCinsiyet();?>
</div>
...
<input name="work" id="work" type="text" class="inputbox" alt="work" placeholder="Çalıştığınız kurumu yazın" size="15" />
</div>
