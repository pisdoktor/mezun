...
<link rel="stylesheet" type="text/css" href="<?php echo SITEURL;?>/site/templates/ege_dark/css/style.css" />
<script src="<?php echo SITEURL;?>/site/templates/ege_dark/js/script.js" type="text/javascript"></script>

<link rel="stylesheet" type="text/css" href="<?php echo SITEURL;?>/site/templates/ege_dark/css/cssmenu.css" />
<script src="<?php echo SITEURL;?>/site/templates/ege_dark/js/cssmenu.js" type="text/javascript"></script>
...
<div id="header">
<div id="logo">
<img src="<?php echo SITEURL;?>/site/templates/ege_dark/images/logo.png" border="0" alt="<?php echo SITEHEAD;?>" title="<?php echo SITEHEAD;?>" />
</div>
</div>
